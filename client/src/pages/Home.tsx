...
const chapterIllustrations: Record<string, string> = {
  "1-1": "/manus-storage/genesis-1-creation_c5b3aed4.png",
  "1-2": "/manus-storage/genesis-2-garden_a2558bd2.png",
  "1-3": "/manus-storage/genesis-3-garden-choice_053ffb26.png",
};
...
export default function Home() {
  ...
  const illustrationSrc = chapterIllustrations[chapterKey];
